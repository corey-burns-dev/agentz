...
export const KeybindingWhenNode: Schema.Schema<KeybindingWhenNode> =
	Schema.Union([
		Schema.Struct({
		...
		Schema.Struct({
			...
			node: Schema.suspend(
				(): Schema.Schema<KeybindingWhenNode> => KeybindingWhenNode,
			),
		}),
		Schema.Struct({
...
export const ResolvedKeybindingsConfig = Schema.Array(
