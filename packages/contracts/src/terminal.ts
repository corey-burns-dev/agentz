...
export type TerminalThreadInput = Schema.Codec.Encoded<
	typeof TerminalThreadInput
>;
...
export type TerminalCloseInput = Schema.Codec.Encoded<
	typeof TerminalCloseInput
>;
