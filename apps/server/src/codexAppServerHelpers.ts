...
export function buildCollaborationModeForInteraction(input: {
	...
	if (input.interactionMode === "plan" || input.interactionMode === "default") {
		return buildCodexCollaborationMode({
