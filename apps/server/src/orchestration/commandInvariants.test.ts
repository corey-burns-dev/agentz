...
describe("commandInvariants", () => {
  it("finds projects by id", () => {
    expect(findProjectById(readModel, ProjectId.makeUnsafe("project-a"))?.title).toBe("Project A");
    expect(findProjectById(readModel, ProjectId.makeUnsafe("missing"))).toBeUndefined();
  });
