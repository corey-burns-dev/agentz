...
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@agents/shared/git";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    const filePath = path.join(tempDir, `agents-${prefix}-${process.pid}-${randomUUID()}.tmp`);
