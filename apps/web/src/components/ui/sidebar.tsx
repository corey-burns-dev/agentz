...
function SidebarProvider({
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        className={cn(
          "sidebar-density-wrapper group/sidebar-wrapper flex min-h-svh w-full min-w-0 has-data-[variant=inset]:bg-sidebar",
          className,
        )}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      className={cn(
        "sidebar-density-inset relative flex w-full min-w-0 flex-1 flex-col bg-background",
...
function SidebarInput({ className, ...props }: React.ComponentProps<typeof Input>) {
  return (
    <Input
      className={cn("sidebar-density-input h-8 w-full bg-background shadow-none", className)}
      data-sidebar="input"
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn("sidebar-density-header flex flex-col gap-2 p-2", className)}
      data-sidebar="header"
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn("sidebar-density-footer flex flex-col gap-2 p-2", className)}
      data-sidebar="footer"
...
function SidebarSeparator({ className, ...props }: React.ComponentProps<typeof Separator>) {
  return (
    <Separator
      className={cn("sidebar-density-separator mx-2 w-auto bg-sidebar-border", className)}
