import type { GitStackedAction, GitStatusResult, ThreadId } from "@agents/contracts";
...
export default function GitActionsControl({ gitCwd, activeThreadId }: GitActionsControlProps) {
  ...
  const runGitActionWithToast = useCallback(
    ...
    [isDefaultBranch, runImmediateGitActionMutation, threadToastData, gitStatusForActions],
  );
