...
import { type deriveTimelineEntries, formatElapsed, formatTimestamp } from "../session-logic";
...
const ChangedFilesTree = memo(function ChangedFilesTree(props: {
  ...
  return <div className="space-y-0">{treeNodes.map((node) => renderTreeNode(node, 0))}</div>;
});
