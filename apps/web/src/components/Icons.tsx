...
export const GitHubIcon: Icon = (props) => (
  <svg {...props} aria-hidden viewBox="0 0 1024 1024" fill="none">
    <title>GitHub</title>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const CursorIcon: Icon = (props) => (
  <svg {...props} aria-hidden viewBox="0 0 466.73 532.09" fill="currentColor">
    <title>Cursor</title>
...
export const VisualStudioCode: Icon = (props) => {
  ...
  return (
    <svg {...props} aria-hidden fill="none" viewBox="0 0 100 100">
...
export const Antigravity: Icon = (props) => {
  const id = useId();
  const gradId = `${id}-antigravity-grad`;
  const glowId = `${id}-antigravity-glow`;

  return (
    <svg {...props} aria-hidden viewBox="0 0 256 256" fill="none">
      ...
      <path d="M128 40L40 216H80L128 120L176 216H216L128 40Z" fill={`url(#${gradId})`} />

      <circle cx="128" cy="160" r="24" fill="white" filter={`url(#${glowId})`} />

      <rect x="85" y="190" width="86" height="8" rx="4" fill="currentColor" />
    </svg>
  );
};
...
export const Zed: Icon = (props) => {
  ...
  return (
    <svg {...props} aria-hidden fill="none" viewBox="0 0 96 96">
      <title>Codeium</title>
...
export const ClaudeAI: Icon = (props) => (
  <svg {...props} aria-hidden preserveAspectRatio="xMidYMid" viewBox="0 0 256 257">
    <title>Claude</title>
    <path
      fill="#D97757"
...
export const Gemini: Icon = (props) => (
  <svg {...props} aria-hidden viewBox="0 0 296 298" fill="none">
    <title>Gemini</title>
    <mask
      id="gemini__a"
      width="296"
