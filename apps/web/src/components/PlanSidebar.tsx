import type { ModelSlug, ProviderKind } from "@agents/contracts";
import {
  CheckIcon,
  ChevronDownIcon,
  ChevronRightIcon,
...
import type { AppServiceTier } from "../appSettings";
import {
...
import { ProviderModelPicker } from "./ChatViewComposerArea";
...
interface PlanSidebarProps {
  ...
  onClose: () => void;
  /** Provider/model for "Implement plan in new thread"; not locked to current thread. */
  implementationProvider: ProviderKind;
  implementationModelForPicker: ModelSlug;
  ...
  onImplementationProviderModelChange: (provider: ProviderKind, model: ModelSlug) => void;
