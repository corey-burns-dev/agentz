...
import { NotificationsSection, ResponsesSection } from "./settings/-NotificationsSection";
import { ProvidersSection } from "./settings/-ProvidersSection";
import { SafetySection } from "./settings/-SafetySection";
import { parseSettingsTab, SETTINGS_TABS, type SettingsTab } from "./settings/-settingsNavigation";
...
function navigateBackFromSettings(navigate: ReturnType<typeof useNavigate>): void {
...
function SettingsTabButton({
  ...
  return (
    ...
    >
      ...
      {mobile ? null : (
        <p className="mt-0.5 text-[11px] text-muted-foreground/80">{tab.description}</p>
      )}
    </button>
  );
}
