	...
	persist(
		(set, get) => ({
			...
			setPrompt: (threadId, prompt) => {
				...
				set(
					(state) =>
						applyDraftFieldUpdate(state, threadId, "prompt", prompt) ?? state,
				);
			},
			...
			setRuntimeMode: (threadId, runtimeMode) => {
				...
				set(
					(state) =>
						applyDraftFieldUpdate(state, threadId, "runtimeMode", value) ??
						state,
				);
			},
			setInteractionMode: (threadId, interactionMode) => {
				...
				set(
					(state) =>
						applyDraftFieldUpdate(state, threadId, "interactionMode", value) ??
						state,
				);
			},
			setEffort: (threadId, effort) => {
				...
				set(
					(state) =>
						applyDraftFieldUpdate(state, threadId, "effort", value) ?? state,
				);
			},
