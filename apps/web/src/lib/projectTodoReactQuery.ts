...
import { PROJECT_TODO_FILE_CANDIDATES, selectProjectTodoFile } from "~/projectTodos";
...
export function projectTodoFileQueryOptions(input: { cwd: string | null; enabled?: boolean }) {
  return queryOptions({
